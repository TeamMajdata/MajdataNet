    ...
    <PageLayout className="pb-8">
      ...
      {hasRecentPlayed !== false && (
        <motion.section
          ...
          variants={slideInUp}
        >
          <h2 className="my-8 font-semibold text-ink text-2xl md:text-3xl text-center">
            {loc('RecentlyPlayedCharts', '最近游玩的谱面')}
          </h2>
          <div className="mx-auto my-8 bg-line w-[70%] h-px" />
    ...
    <div className="p-6 md:p-8 rounded-xl">
      ...
      <div className="flex md:flex-row flex-col items-center gap-8 max-md:gap-6 mb-8 pb-8 border-line border-b md:text-left text-center">
        ...
        <div className="flex-1">
          <h1 className="mb-2 font-bold text-[2rem] text-ink max-md:text-2xl">{data.username}</h1>
          <p className="m-0 text-ink-3 text-base text-right">
      ...
      {data.introduction && (
        <div className="mt-4">
          <h3 className="mb-4 font-semibold text-ink text-xl text-center">
            {loc('SelfIntro', '自我介绍')}
          </h3>
          <article className="p-6 rounded-lg select-text **:select-text markdown-body">
            <Markdown
