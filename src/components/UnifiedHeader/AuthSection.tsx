  ...
  return (
    <div className="relative">
      ...
      <div className="md:hidden block relative">
        ...
        <Dropdown isOpen={isMobileAuthMenuOpen} onClose={() => setIsMobileAuthMenuOpen(false)} position="right" className="p-4">
          ...
          <Link to="/register" className="flex justify-center items-center gap-3 bg-linear-to-br from-[rgb(16_185_129/20%)] hover:from-[rgb(16_185_129/30%)] to-[rgb(5_150_105/15%)] hover:to-[rgb(5_150_105/25%)] px-5 py-4 border-none w-full font-semibold text-[#10b981] hover:text-[#34d399] text-sm text-center no-underline cursor-pointer">
