      ...
      <div className="flex justify-between items-center mx-auto my-2 md:my-4 px-10 max-w-350 h-12 md:h-16">
        ...
        <div className="md:hidden left-1/2 absolute flex items-center h-8 -translate-x-1/2">
          <Link to="/" className="flex items-center">
            <img className="rounded-[5px] w-8 h-8" src="../../../salt.webp" alt="xxlb" />
          </Link>
        </div>
